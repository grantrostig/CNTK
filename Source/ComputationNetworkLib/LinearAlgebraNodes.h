    ...
    virtual void /*ComputationNode::*/ BackpropTo(const size_t inputIndex, const FrameRange& fr) override
    {
        ...
        if (inputIndex == 0) // left derivative
        {
            ...
            if (InputRef(1).Value().GetMatrixType() == SPARSE && InputRef(0).Gradient().GetMatrixType() == DENSE && Gradient().GetMatrixType() == DENSE)
            {
                ...
                auto newInput0SparseGradientMatrix = Matrix<ElemType>(currentInput0GradientMatrixRef.GetNumRows(),
                ...
                currentInput0GradientMatrixRef = std::move(newInput0SparseGradientMatrix);
            }
